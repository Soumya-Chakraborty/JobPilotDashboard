  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-n-8">
      <div className="w-full max-w-md rounded-2xl bg-n-7 p-8 shadow-lg">
        ...
        <h2 className="mb-6 text-center text-2xl font-bold text-n-1">Create Your Job Pilot Account</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="name" className="mb-1 block text-sm font-medium text-n-3">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div className="mb-6">
            <label htmlFor="confirmPassword" className="mb-1 block text-sm font-medium text-n-3">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-n-4">
            ...
            <a href="/signin" className="text-color-1 hover:underline">
              Sign in
            </a>
          </p>
        </div>
